    ...
    <div className={styles.home}>
      <section className={styles.cardsContainer}>
        <div className={styles.card}>
          <a href="https://www.youtube.com/watch?v=S4GSIhQhfFM" target="_blank">
            <img src={foto1} alt="" />
          </a>
        ...
        <div className={styles.card}>
          <a href="https://www.youtube.com/watch?v=k7Pekud0fdU" target="_blank">
        ...
        <div className={styles.card}>
          <a href="https://www.youtube.com/watch?v=SJjBNWPQMjE" target="_blank">
            <img src={foto6} alt="" />
          </a>
